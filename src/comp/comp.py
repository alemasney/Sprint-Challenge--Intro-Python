...
# [human.name for human in humans if human.name[0] is between 'C' and 'G']

c = [human.name for human in humans if "B" < human.name[0] < "H"]
print(c)
...
f = [(human.name, human.age) for human in humans if 27 < human.age < 33 ]
print(f)
